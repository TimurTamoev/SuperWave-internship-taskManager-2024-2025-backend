...
@router.get("/user/get/me", response_model=UserResponse)
async def get_current_user_info(current_user: User = Depends(get_current_user)):
    return current_user


@router.get("/user/get/all", response_model=List[UserResponse])
...
@router.patch("/user/deactivate/{user_id}", response_model=UserResponse)
...
@router.patch("/user/activate/{user_id}", response_model=UserResponse)
...
@router.patch("/user/update/{user_id}", response_model=UserResponse)
